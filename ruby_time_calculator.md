...
### 2. Identify merge conflict in README.md
...
### 3. Edit README.md
In README.md, keep the file changes from the edits branch. Delete the file changes from HEAD. Remember to delete all of Git’s special markings that indicate a merge conflict.
